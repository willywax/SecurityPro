...
const App=()=> <BrowserRouter><Routes><Route path='/' element={<Layout/>}>
  ...
  <Route path='reports' element={<div className='card'>Reports: use statement endpoint and A/R summary from API.</div>}/>
